...
from scanner.ai.prompts import IMPACT_ANALYSIS_SYSTEM_PROMPT, IMPACT_ANALYSIS_USER_PROMPT
...
class PRScanSummary:
    ...
    repository: str = ""  # e.g. owner/repo from GITHUB_REPOSITORY
...
class DiffScanner:
    ...
    def _analyze_impact(
        ...
        user_prompt = IMPACT_ANALYSIS_USER_PROMPT.format(
        ...
        messages = [
            {"role": "system", "content": IMPACT_ANALYSIS_SYSTEM_PROMPT},
